...
#保存图片
plt.savefig('Comparation of different models.png', dpi=1080 ,bbox_inches='tight')
...
plt.savefig('Feature importance - ExtraTrees.png', dpi=1080 ,bbox_inches='tight')
plt.show()
# ------------------------ ExtraTrees END ------------------------------
...
plt.yticks(ylocs, feature_labels)
plt.savefig('Feature importance - Xgboost.png', dpi=1080 ,bbox_inches='tight')
plt.show()
# ------------------------ xgboost END ------------------------------

# ------------------------ lightgbm ------------------------------
ax = lgb.plot_importance(lgbc)
fig = ax.figure
fig.set_size_inches(50, 50)
#plt.savefig('xgbcf.png')
...
plt.ylabel('Features')
plt.xlabel('Importance Score')
plt.title('Positive Feature Importance Score - Lightgbm Classifier')
plt.yticks(ylocs, feature_labels)
plt.savefig('Feature importance - Lightgbm.png', dpi=1080 ,bbox_inches='tight')
plt.show()
# ------------------------ lightgbm END ------------------------------
...
lgbc = LGBMClassifier()
lgbc.fit(x_train_new, y_train)
ypred = lgbc.predict(x_test_new)
